...
<div class="row">
    <div class="column" style="background-color:#aaa;">
        ...
        <strong>PRENOMS:</strong> {{ $person->first_name }}<br>
        <strong>NOMS:</strong> {{ $person->last_name }}<br>
        <strong>GDES:</strong> {{ $person->gdes }}<br>
        <strong>MLES:</strong> {{ $person->mles }}<br>
        <strong>D.NAISS:</strong> {{ $person->date_of_birth }}<br>
        <strong>N°CIN:</strong> {{ $person->cin }}<br>
        <strong>N.E:</strong> {{ $person->ne }}<br>
        <strong>T.I%:</strong> {{ $person->ti_percentage }}<br>
        <strong>DIP.MIL:</strong> {{ $person->diploma_mil }}<br>
        <strong>SPECIALITES:</strong> {{ $person->specialties }}<br>
        <strong>DIP.SCOL.:</strong> {{ $person->diploma_scol }}<br>
        <strong>EMPLOI TENU:</strong> {{ $person->employment }}<br>
        <strong>POSITION:</strong> {{ $person->position }}<br>
        <strong>PROMOTION:</strong> {{ $person->promotion }}<br>
        <strong>SEXE:</strong> {{ $person->sex }}<br>
    </div>
