...
<aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
        ...
        <i class="bi bi-journal-text"></i><span>CCS</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
    ...
    <li class="nav-item">
        ...
        <i class="bi bi-gem"></i><span>Soutien</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
    ...
    <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a class="nav-link collapsed" onclick="event.preventDefault(); this.closest('form').submit();" href="">
        ...
        <footer id="footer" class="footer">
            <div class="copyright">
            &copy; Copyright <strong><span>E.R.M</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
            ...
            Designed by <a href="">ISTA Groupe</a>
            </div>
        </footer><!-- End Footer -->
